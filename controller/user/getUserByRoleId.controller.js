const getByRoleIdUser = require("../../model/services/user/getByRoleIdUser");
const sanitizeBody = require("../../utils/sanitizeBody");

const getUserByRoleId = async (req, res, next) =>{
    try {
        const {clientId, roleId} = await sanitizeBody(req.params)
