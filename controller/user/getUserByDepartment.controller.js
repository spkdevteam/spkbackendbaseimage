const getUserByDept = require("../../model/services/user/getUserByDept")
const sanitizeBody = require("../../utils/sanitizeBody")

const getUserByDepartment = async (req, res, next) =>{
    try {
